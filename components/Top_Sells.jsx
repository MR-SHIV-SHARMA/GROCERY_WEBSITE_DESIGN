  ...
  return (
    <div className="flex justify-evenly items-center my-20">
      <div className="space-y-2">
        ...
        <div className="space-y-10 pt-8">
          <div className="flex justify-start items-center gap-2">
            <Image src={image_5} className="bg-gray-100" alt="orange 1kg" />
            <div className="space-y-2">
              ...
              <div className="flex text-gray-400 items-center ">
                ...
                <Image src={Star} alt="star" />
                <Image src={Star} alt="star" />
                <Image src={Black_Star} alt="black star" />
                (4)
              </div>
          ...
          <div className="flex justify-start items-center gap-2">
            <Image src={image_2} className="bg-gray-100" alt="orange 1kg" />
            <div>
              <h1 className="font-bold">Orange 1kg</h1>
              <div className="flex text-gray-400 items-center ">
                <Image src={Star} alt="star" />
          ...
          <div className="flex justify-start items-center gap-2">
            <Image src={image_3} className="bg-gray-100" alt="orange 1kg" />
            <div>
              <h1 className="font-bold">Orange 1kg</h1>
              <div className="flex text-gray-400 items-center ">
                <Image src={Star} alt="star" />
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-10 pt-8">
          <div className="flex justify-start items-center gap-2">
            <Image src={image_1} className="bg-gray-100" alt="orange 1kg" />
            <div className="space-y-2">
              <h1 className="font-bold">Orange 1kg</h1>
              <div className="flex text-gray-400 items-center ">
                <Image src={Star} alt="star" />
          ...
          <div className="flex justify-start items-center gap-2">
            <Image src={image_4} className="bg-gray-100" alt="orange 1kg" />
            <div>
              <h1 className="font-bold">Orange 1kg</h1>
              <div className="flex text-gray-400 items-center ">
                <Image src={Star} alt="star" />
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-10 pt-8">
          <div className="flex justify-start items-center gap-2">
            <Image src={image_7} className="bg-gray-100" alt="orange 1kg" />
            <div className="space-y-2">
              <h1 className="font-bold">Orange 1kg</h1>
              <div className="flex text-gray-400 items-center ">
                <Image src={Star} alt="star" />
          ...
          <div className="flex justify-start items-center gap-2">
            <Image src={image_6} className="bg-gray-100" alt="orange 1kg" />
            <div>
              <h1 className="font-bold">Orange 1kg</h1>
              <div className="flex text-gray-400 items-center ">
                <Image src={Star} alt="star" />
